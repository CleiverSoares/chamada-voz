...
<div class="min-h-screen bg-gradient-to-br from-[#0a0e27] via-[#0d1235] to-[#0a0e27] py-12 px-6">
    <div class="max-w-7xl mx-auto">
        <!-- Dashboard Header -->
        <div class="mb-12">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <div class="text-[#0667DA] text-sm font-bold uppercase tracking-[0.3em] mb-2">Sistema de Análise</div>
                    <h1 class="text-5xl font-black text-white tracking-tight">DASHBOARD DE PERFORMANCE</h1>
                </div>
                <div class="hidden md:flex items-center space-x-3 bg-[#0d1235] border border-[#0667DA]/30 rounded-xl px-6 py-3">
                    <div class="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                    <span class="text-white font-bold">Sistema Online</span>
                </div>
            </div>
        ...
        <div class="grid md:grid-cols-4 gap-6 mb-12">
            ...
            <div class="dashboard-stat-card" style="animation-delay: 0s">
                <div class="flex items-center justify-between mb-4">
                    <div class="text-[#0667DA] text-xs font-bold uppercase tracking-wider">Total Missões</div>
                ...
                <div class="text-5xl font-black text-white mb-1">{{ $estatisticas['total'] }}</div>
                <div class="text-sm text-gray-400">Simulações completas</div>
            </div>
            
            <!-- Average Score -->
            <div class="dashboard-stat-card" style="animation-delay: 0.1s">
                <div class="flex items-center justify-between mb-4">
                    <div class="text-green-400 text-xs font-bold uppercase tracking-wider">Média Geral</div>
                ...
                <div class="text-5xl font-black text-green-400 mb-1">{{ $estatisticas['media_score'] ?? 0 }}</div>
                <div class="text-sm text-gray-400">Pontuação média</div>
            </div>
            
            <!-- Best Score -->
            <div class="dashboard-stat-card" style="animation-delay: 0.2s">
                <div class="flex items-center justify-between mb-4">
                    <div class="text-yellow-400 text-xs font-bold uppercase tracking-wider">Recorde</div>
                ...
                <div class="text-5xl font-black text-yellow-400 mb-1">{{ $estatisticas['melhor_score'] ?? 0 }}</div>
                <div class="text-sm text-gray-400">Melhor pontuação</div>
            </div>
            
            <!-- Total Time -->
            <div class="dashboard-stat-card" style="animation-delay: 0.3s">
                <div class="flex items-center justify-between mb-4">
                    <div class="text-purple-400 text-xs font-bold uppercase tracking-wider">Tempo Total</div>
                ...
                <div class="text-5xl font-black text-purple-400 mb-1">{{ gmdate('H:i', $estatisticas['total_tempo'] ?? 0) }}</div>
                <div class="text-sm text-gray-400">Horas treinadas</div>
            </div>
        </div>
        ...
        <div class="dashboard-table-container">
            <div class="flex items-center justify-between mb-6 px-6 pt-6">
                <h2 class="text-2xl font-black text-white uppercase tracking-tight">Registro de Missões</h2>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-y border-[#0667DA]/30">
                            <th class="px-6 py-4 text-left text-xs font-bold text-[#0667DA] uppercase tracking-wider">Agente</th>
                            <th class="px-6 py-4 text-left text-xs font-bold text-[#0667DA] uppercase tracking-wider">Alvo</th>
                            <th class="px-6 py-4 text-center text-xs font-bold text-[#0667DA] uppercase tracking-wider">Score</th>
                            <th class="px-6 py-4 text-center text-xs font-bold text-[#0667DA] uppercase tracking-wider">Duração</th>
                            <th class="px-6 py-4 text-center text-xs font-bold text-[#0667DA] uppercase tracking-wider">Data/Hora</th>
                            <th class="px-6 py-4 text-center text-xs font-bold text-[#0667DA] uppercase tracking-wider">Ação</th>
                        </tr>
                    </thead>
