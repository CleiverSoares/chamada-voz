...
<body class="bg-[#0a0e27] text-white @yield('body-class', '')">
    <!-- Floating Navigation -->
    <nav class="fixed top-6 right-6 z-50 flex items-center space-x-3">
    ...
    <div class="fixed top-6 left-6 z-50">
        <img src="{{ asset('images/Alterdata_Horizontal_branca.svg') }}" alt="Alterdata" class="h-8 opacity-80 hover:opacity-100 transition">
    </div>
